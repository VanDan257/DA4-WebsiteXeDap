<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
      ...
      <div class="col-lg-4 d-none d-lg-block" style="padding: 10px;">
        <a href="{{ route('dashboard') }}" class="text-decoration-none">
            <h3 class="m-0 h3 font-weight-semi-bold"><span class="text-white bg-dark font-weight-bold border px-3 mr-1">CYCLE</span><span class="text-dark">SHOP</span></h3>
        </a>
    </div>
  </div>
  <hr class="horizontal dark mt-0">
  <div class="collapse navbar-collapse  w-auto " style="overflow: initial;" id="sidenav-collapse-main">
      <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
              <a class="nav-link  " href="{{ route('indexdm') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
              <a class="nav-link  " href="{{ route('indexsp') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i class="fa-solid fa-bicycle"></i>
                  </div>
                  <span class="nav-link-text ms-1">Xe đạp</span>
              </a>
          </li>
          <li class="nav-item">
              <a class="nav-link  " href="/Admin/Providers/Index">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
              <a class="nav-link  " href="/Admin/Customers/Index">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
              <a class="nav-link  " href="{{ route('indexdh') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
